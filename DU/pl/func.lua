...
--
-- Dependencies: `pl.plutils`, `pl.tablex`
-- @module pl.func
...
local pairs,rawget,unpack,pack = pairs,rawget,plutils.unpack,plutils.pack
local tablex = require 'pl.tablex'
local map = tablex.map
local _DEBUG = rawget(_G,'_DEBUG')
local assert_arg = plutils.assert_arg
...
plutils.add_function_factory(_PEMT,func.I)
...
-- @return a function
-- @usage printf = compose(write,string.format)
