...
--
-- Dependencies: `pl.plutils`, `pl.types`
-- @module pl.tablex
...
local min = math.min
local pairs,type,unpack,select,tostring = pairs,type,plutils.unpack,select,tostring
local function_arg = plutils.function_arg
