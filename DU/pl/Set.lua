...
--
-- Dependencies: `pl.plutils`, `pl.tablex`, `pl.class`, `pl.Map`, (`pl.List` if __tostring is used)
-- @classmod pl.Set

local tablex = require 'pl.tablex'
local plutils = require 'pl.plutils'
local array_tostring, concat = plutils.array_tostring, table.concat
local merge,difference = tablex.merge,tablex.difference
local Map = require 'pl.Map'
local class = require 'pl.class'
local stdmt = plutils.stdmt
local Set = stdmt.Set
