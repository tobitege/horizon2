RotationDamping = (function() 
    local this = HorizonModule("Rotation Damping", "Slows rotation over time, preventing unintended spin", "PostFlush", true)
...
Horizon.RegisterModule(RotationDamping)