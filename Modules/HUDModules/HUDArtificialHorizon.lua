...
HUDArtificialHorizon = (function()
    ...
    rollText.Transform = function(rollAmount)
        if rollAmount > 180 then rollAmount = rollAmount - 360 end
        local adjustedRoll = math.floor(rollAmount * 10 + 0.5) / 10
        return math.abs(adjustedRoll)
    end
